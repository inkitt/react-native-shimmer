...
//    }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.RNShimmeringView);
            gravity = a.getInt(R.styleable.RNShimmeringView_android_layout_gravity, gravity);
            position = a.getInt(R.styleable.RNShimmeringView_layout_position, position);
            a.recycle();
        }
